...
1. The information for these 412 proteins is provided in [`data/412pro_info.csv`](./data/412pro_info.csv). Please download the corresponding mutation effect data (412pros_ddG_ML.csv) from [Zenodo](https://zenodo.org/records/17488191).
